 ...
 * @subpackage GutenbergBlockExamples/admin
 */
...
class Admin {
	...
	public function enqueue_styles() {
		 ...
		 * defined in GutenbergBlockExamples_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The GutenbergBlockExamples_Loader will then create the relationship
