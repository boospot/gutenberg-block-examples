...
if ( class_exists( 'GutenbergBlockExamples\Globals' ) ) {
	return;
}
...
class Globals {
	...
	public static function get_default_options_array() {
		...
		$default_options = apply_filters( 'gbe_admin_settings_default', $default_options );
	...
	public static function get_meta_prefix() {
		return apply_filters( 'gbe_global_meta_prefix', static::$prefix );
	}
