 ...
 * @subpackage GutenbergBlockExamples/public
 */
...
class Front {
	...
	public function enqueue_styles() {
		 ...
		 * defined in GutenbergBlockExamples\Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The GutenbergBlockExamples\Loader will then create the relationship
